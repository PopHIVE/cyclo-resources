...
flowchart LR
    ...
    s6(("<strong><a href="https://infogram.com/cyclospora-in-kentucky-1hnp27ejvprdy4g" target="_blank" rel="noreferrer">Kentucky cyclosporiasis county map, as published in allowlisted news outlets' Infogram embeds</a></strong>"))
    s7(("<strong><a href="https://www.michigan.gov/mdhhs/keep-mi-healthy/infectious-diseases/infectious-disease-outbreaks" target="_blank" rel="noreferrer">MDHHS Cyclosporiasis Outbreak - Cases by County</a></strong>"))
    s9(("<strong><a href="https://data.ohio.gov/wps/portal/gov/data/view/summary-of-infectious-diseases-in-ohio" target="_blank" rel="noreferrer">Summary of Infectious Diseases in Ohio</a></strong>"))
    s11(("<strong><a href="https://www.oregon.gov/oha/ph/diseasesconditions/communicabledisease/diseasesurveillancedata/weekly-monthlystatistics/pages/index.aspx" target="_blank" rel="noreferrer">Monthly CD Surveillance Report (Tableau Public)</a></strong>"))
    ...
    s5 --> n4
    s6 --> n4
    s7---s8["<strong><a href="https://www.michigan.gov/mdhhs/keep-mi-healthy/infectious-diseases/infectious-disease-outbreaks" target="_blank" rel="noreferrer">"Detailed Outbreak Data" accordion, "Cases by county" section, on the Infectious Disease Outbreaks page</a></strong>"]
    s8 --> n5
    s9---s10["<strong><a href="https://analytics.das.ohio.gov/t/ODHDPPUB/views/GeneralCaseCountPublicPROD/GeographicalDistribution" target="_blank" rel="noreferrer">Tableau Server dashboard (site ODHDPPUB, workbook GeneralCaseCountPublicPROD, view GeographicalDistribution)</a></strong>"]
    s10 --> n6
    s11---s12["<strong><a href="https://public.tableau.com/views/MonthlyReportDashboard_EXTERNAL_AGGREGATED/MonthlyReportDashboard" target="_blank" rel="noreferrer">Tableau Public workbook 'MonthlyReportDashboard_EXTERNAL_AGGREGATED', view 'MonthlyReportDashboard' ('Statewide' and 'by County' tabs)</a></strong>"]
    s12 --> n7
    s13---s14["<strong><a href="https://oeps.wv.gov/cyclosporiasis-outbreak" target="_blank" rel="noreferrer">"Cases by County" panel embedded in the dashboard image on the Cyclosporiasis Outbreak page</a></strong>"]
    s14 --> n8
```
